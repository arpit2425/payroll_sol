...
const CodeBlock: React.FC<CodeBlockProps> = ({ code }) => (
    <pre className="bg-slate-900 border border-slate-700 rounded-lg p-4 overflow-x-auto my-4">
        <code className="text-[#14f195] text-sm font-mono">{code}</code>
    </pre>
);

const FeatureCard: React.FC<FeatureCardProps> = ({ icon: Icon, title, description, items }) => (
    <div className="group p-6 bg-linear-to-br from-slate-900/50 to-slate-800/30 border border-[#14f195]/20 rounded-2xl backdrop-blur-sm hover:border-[#14f195]/60 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#14f195]/20 relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-br from-[#14f195]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

        <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-linear-to-br from-[#14f195] to-[#14f195] rounded-lg flex items-center justify-center shadow-lg shadow-[#14f195]/50">
                    <Icon className="w-5 h-5 text-black" />
                </div>
                <h3 className="text-lg font-bold text-white group-hover:text-[#14f195] transition-colors">{title}</h3>
            </div>
        ...
        <div className="border-b border-slate-800/50">
            ...
            >
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-linear-to-br from-[#14f195]/20 to-[#14f195]/20 rounded-lg flex items-center justify-center group-hover:from-[#14f195]/40 group-hover:to-[#14f195]/40 transition-all">
                        <Icon className="w-6 h-6 text-[#14f195]" />
                    </div>
                    <h2 className="text-2xl font-bold text-white group-hover:text-[#14f195] transition-colors">{title}</h2>
                </div>
                <ChevronDown
            ...
            <main className="max-w-7xl mx-auto pb-20 px-6 pt-32">
                ...
                <Section id="installation" title="Installation & Setup" icon={Terminal}>
                    <div className="space-y-6">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
                                <Terminal className="w-5 h-5 text-[#14f195]" />
                                Installation Steps
                            </h3>
                    ...
                    <div className="space-y-8">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
                                <Zap className="w-7 h-7 text-[#14f195]" />
                            ...
                            <div className="overflow-x-auto rounded-lg border border-slate-700">
                                <table className="w-full text-sm text-left text-slate-300">
                                    ...
                                    <tbody className="divide-y divide-slate-700">
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">List all organizations</td><td className="px-6 py-4 font-mono text-[#14f195]">Show my organizations</td><td className="px-6 py-4">Shows treasury balances</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">View org details</td><td className="px-6 py-4 font-mono text-[#14f195]">Show details for Tesla</td><td className="px-6 py-4">Workers, salaries, last paid</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Create organization</td><td className="px-6 py-4 font-mono text-[#14f195]">Create organization Apple</td><td className="px-6 py-4">Instantly created</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Add worker</td><td className="px-6 py-4 font-mono text-[#14f195]">Add worker 7yQ... to Tesla salary 3.5 SOL</td><td className="px-6 py-4">Worker added</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Fund treasury</td><td className="px-6 py-4 font-mono text-[#14f195]">Fund Tesla with 20 SOL</td><td className="px-6 py-4">SOL transferred</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Pay everyone</td><td className="px-6 py-4 font-mono text-[#14f195]">Process payroll for Tesla</td><td className="px-6 py-4">All workers paid</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Withdraw</td><td className="px-6 py-4 font-mono text-[#14f195]">Withdraw 8 SOL from Tesla</td><td className="px-6 py-4">Sent to your wallet</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div className="bg-slate-900/50 border border-[#14f195]/20 rounded40-lg p-4">
                            <div className="flex gap-3">
                                <AlertCircle className="w-5 h-5 text-[#14f195] shrink-0 mt-0.5" />
                                <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div key={item.step} className="flex gap-4 p-4 bg-slate-800/30 rounded-lg border border-slate-700/50 hover:border-[#14f195]/30 transition-all">
                                        <div className="w-8 h-8 bg-linear-to-br from-[#14f195] to-[#14f195] rounded-lg flex items-center justify-center shrink-0 text-black font-bold text-sm">
                                            {item.step}
                                        </div>
                                        <div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={i} className="p-4 bg-slate-800/50 rounded-lg border border-slate-700/50 hover:border-[#14f195]/30 transition-all">
                                        <div className="flex items-start justify-between mb-2">
                                            <h4 className="font-mono font-bold text-[#14f195]">{fn.name}</h4>
                                            <span className="px-2 py-1 text-xs bg-[#14f195]/20 text-[#14f195] rounded">Function</span>
                                        </div>
                                        <p className="text-sm text-slate-300 mb-2">{fn.desc}</p>
                                        <div className="grid grid-cols-2 gap-2 text-xs">
                                            <div><span className="text-slate-400">Parameters:</span><p className="text-[#14f195]">{fn.params}</p></div>
                                            <div><span className="text-slate-400">Returns:</span><p className="text-[#14f195]">{fn.returns}</p></div>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-slate-300 mb-4">
                                Navigate to the <span className="text-[#14f195]">/test</span> page to access a comprehensive test interface with all blockchain functions.
                            </p>
                ...
                <Section id="mobile" title="Mobile & Tablet Experience" icon={Smartphone}>
                    <div className="space-y-4 text-slate-300">
                        ...
                        <ul className="space-y-3 ml-4">
                            <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-[#14f195] shrink-0 mt-0.5" /> The organizations panel is hidden by default</li>
                            <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-[#14f195] shrink-0 mt-0.5" /> Tap the <strong>glowing menu button</strong> (bottom-right or top-right) to open it</li>
                            <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-[#14f195] shrink-0 mt-0.5" /> Chat takes full width for easier typing</li>
                            <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-[#14f195] shrink-0 mt-0.5" /> Swipe the panel away when done</li>
                        </ul>
                ...
                <Section id="troubleshooting" title="Common Issues & Pro Tips" icon={HelpCircle}>
                    <div className="space-y-6">
                        ...
                        <div className="bg-linear-to-r from-[#14f195]/10 to-[#14f195]/10 border border-[#14f195]/30 rounded-xl p-6">
                ...
                <div className="mt-12 p-6 bg-linear-to-br from-slate-900/50 to-slate-800/30 border border-[#14f195]/20 rounded-2xl">
                ...
                <div className="mt-12 grid md:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={i} className="p-4 bg-slate-900/50 border border-slate-800 rounded-lg text-center hover:border-[#14f195]/30 transition-all">
                            <div className="text-2xl font-bold bg-linear-to-r from-[#14f195] to-[#14f195] bg-clip-text text-transparent mb-1">
                                {stat.value}
                            </div>
