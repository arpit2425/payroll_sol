        ...
        },
        {
            ...
            content: (
                <ul className="space-y-4 text-slate-400">
                    <li className="flex items-start gap-4 p-4 bg-slate-800/40 rounded-xl border border-[#14f195]/20">
                        <EyeOff className="w-6 h-6 text-[#14f195] shrink-0 mt-1" />
                        <div>
                    ...
                    <li className="flex items-start gap-4 p-4 bg-slate-800/40 rounded-xl border border-[#14f195]/20">
                        <Zap className="w-6 h-6 text-[#14f195] shrink-0 mt-1" />
                        <div>
                    ...
                    <li className="flex items-start gap-4 p-4 bg-slate-800/40 rounded-xl border border-[#14f195]/20">
                        <Lock className="w-6 h-6 text-[#14f195] shrink-0 mt-1" />
                        <div>
                ...
                <>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        <div className="p-5 bg-slate-800/40 rounded-xl border border-slate-700">
                            <Wallet className="w-8 h-8 text-[#14f195] mb-3" />
                        ...
                        <div className="p-5 bg-slate-800/40 rounded-xl border border-slate-700">
                            <Brain className="w-8 h-8 text-[#14f195] mb-3" />
                        ...
                        <div className="p-5 bg-slate-800/40 rounded-xl border border-slate-700">
                            <Globe className="w-8 h-8 text-[#14f195] mb-3" />
                        ...
                        <div className="p-5 bg-slate-800/40 rounded-xl border border-slate-700">
                            <EyeOff className="w-8 h-8 text-[#14f195] mb-3" />
                    ...
                    <p className="text-sm text-slate-500 mt-6 p-4 bg-slate-900/50 rounded-lg border border-slate-800">
                        <Shield className="w-4 h-4 inline mr-2 text-[#14f195]" />
        ...
        },
        {
            ...
            content: (
                <div className="text-slate-400 space-y-4">
                    ...
                    <p className="mt-6 p-4 bg-slate-800/50 rounded-lg border border-[#14f195]/30">
                        Questions? Reach out anytime: <a href="mailto:contact@dappmentors.org" className="text-[#14f195] hover:text-white underline">contact@dappmentors.org</a>
                    </p>
                </div>
            )
        },
            ...
            <section className="relative z-10 pt-32 pb-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="flex justify-center mb-8">
                        <div className="w-20 h-20 bg-linear-to-br from-[#14f195] to-[#14f195] rounded-2xl flex items-center justify-center shadow-2xl shadow-[#14f195]/50">
                            <Shield className="w-12 h-12 text-black" />
                        </div>
                    </div>
                    <h1 className="text-5xl sm:text-6xl font-bold bg-linear-to-r from-[#14f195] to-[#14f195] bg-clip-text text-transparent mb-6">
                        Privacy Policy
                    </h1>
            ...
            <section className="relative z-10 py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-12">
                    {sections.map((section, i) => (
                        <div
                            key={i}
                            className="group p-8 bg-linear-to-br from-slate-900/60 to-slate-800/40 rounded-2xl border border-slate-700/50 backdrop-blur-sm hover:border-[#14f195]/50 transition-all duration-500"
                        >
                    ...
                    <div className="text-center pt-12">
                        <p className="text-2xl font-bold bg-linear-to-r from-[#14f195] to-[#14f195] bg-clip-text text-transparent">
